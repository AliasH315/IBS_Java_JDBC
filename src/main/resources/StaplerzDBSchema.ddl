...
CREATE TABLE USERS
   (
      USERID INT GENERATED ALWAYS AS IDENTITY NOT NULL CONSTRAINT pk_userid PRIMARY KEY ,
      NAME CHAR(50) NOT NULL,
      ADDRESS VARCHAR(50),
...
INSERT INTO USERS(NAME, ADDRESS, USERNAME, PASSWORD, ACCESSLEVEL) VALUES('Pablo Ono', '123 That Way', 'pabloo', 'birdie',0);
INSERT INTO USERS(NAME, ADDRESS, USERNAME, PASSWORD, ACCESSLEVEL) VALUES('Cesar Diamond', '456 Round Circle', 'cesard', 'signal',0);
INSERT INTO USERS(NAME, ADDRESS, USERNAME, PASSWORD, ACCESSLEVEL) VALUES('Kess Brown', '1 Way Street', 'kessb', 'cortex',0);
INSERT INTO USERS(NAME, ADDRESS, USERNAME, PASSWORD, ACCESSLEVEL) VALUES('Brad Alter', 'Staplerz Main Office', 'admin', 'admin',2);
